...
import type { RootState, AppDispatch } from "../Redux/store"; // make sure these are exported

interface LogoutProps {
  variant?: "navLogout"; // you can add more variants later if needed
}
...
const RightCol = styled.div`
  ...
  ${tabletDevice(`display: none;`)}
`;
const Logout = styled.button<LogoutProps>`
  background: transparent;
  border: none;
  text-transform: uppercase;
  cursor: pointer;
  color: ${(props) => (props.variant === "navLogout" ? "red" : "black")};
`;
...
const NavBar = () => {
  ...
  const quantity = useSelector((state: RootState) => state.cart?.cartQuantity);
